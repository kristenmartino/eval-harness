...
- **Harness infrastructure** end-to-end: adapter Protocol (Ollama + Anthropic + OpenAI), task modules (categorization + summarization), runner with reproducibility headers + resumability, Bradley-Terry pairwise ranking, 25 tests passing on the load-bearing math.
