export const metadata = {
  title: "Executive Summary — Eval Harness",
  description:
    "One-pager for hiring managers. What the eval is, why it's different from public benchmarks, and the five methodology decisions worth flagging.",
};
...
- **A public leaderboard** at [evals.kristenmartino.ai/leaderboard](/leaderboard) with per-task quality, latency, and cost on Pareto frontiers.
- **A [methodology page](/methodology)** documenting every design decision and its rationale.
...
**Methodology page:** [/methodology](/methodology)
**Spec v0.2:** [eval-harness-spec.md](https://github.com/kristenmartino/eval-harness/blob/main/eval-harness-spec.md)
